...
gradient.append("stop")
   .attr('class', 'start')
   .attr("offset", "0%")
   .attr("stop-color", "#52EEFF")
   .attr("stop-opacity", 1);

gradient.append("stop")
   .attr('class', 'end')
   .attr("offset", "100%")
   .attr("stop-color", "#00A1B2")
   .attr("stop-opacity", 1);                
...
y_grid=svg.append("g")     
      ...
      .call(make_y_gridlines()
          .tickSize(-(chart_width - padding*4))
          .tickFormat("")
      );      
...
>>>>>>> f8ac760a1bedb444cb11b1ea84c4ae1b43e74b60
